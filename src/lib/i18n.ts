...
const dict = {
  ja: {
    ...
    about: 'Stellarについて',
    github: 'GitHub',
    developerPlan: '開発者プラン',
    submitAddon: 'アドオン投稿',
    reviewedAddons: '審査済みアドオン',
    officialWiki: '公式Wiki',
    localFirst: 'ローカルファースト研究デスクトップ',
    coordinate: '観測ノード / アーカイブ室 08-1014',
  ...
  fr: {
    ...
    about: 'À propos',
    github: 'GitHub',
    developerPlan: 'Plan développeur',
    submitAddon: 'Soumettre une extension',
    reviewedAddons: 'Extensions examinées',
    officialWiki: 'Wiki officiel',
    localFirst: 'POSTE DE RECHERCHE LOCAL',
    coordinate: 'NOEUD D’OBSERVATION / SALLE D’ARCHIVE 08-1014',
  ...
  af: {
    ...
    about: 'Oor Stellar',
    github: 'GitHub',
    developerPlan: 'Ontwikkelaarsplan',
    submitAddon: 'Dien byvoeging in',
    reviewedAddons: 'Gekeurde byvoegings',
    officialWiki: 'Amptelike Wiki',
    localFirst: 'PLAASLIK-EERSTE NAVORSINGSWERKPLEK',
    coordinate: 'WAARNEMINGSNODE / ARGIEFKAMER 08-1014',
